...
@pytest.fixture(scope='session')
def file_test_list_with_whitespace(tmpdir_factory, string_test_list_with_whitespace):
    """An example of output from
    tempest run --list-tests
    """
    ...
    with open(filename, 'w') as f:
        f.write(string_test_list_with_whitespace)

    return filename


@pytest.fixture(scope='session')
def string_test_list_with_whitespace():
    """An example of output from
    tempest run --list-tests
    """
...
def string_test_list():
    ...
    test_list = \
        ...
        tempest.api.compute.admin.test_aggregates.AggregatesAdminTestJSON.test_three[id-7f6a1cc5-2446-4cdb-9baa-b6ae0a919b72]
        tempest.api.compute.admin.test_aggregates.AggregatesAdminTestJSON.test_four[id-c8e85064-e79b-4906-9931-c11c24294d02]
        tempest.api.compute.admin.test_aggregates.AggregatesAdminTestJSON.test_five[id-0d148aa3-d54c-4317-aa8d-42040a475e20,smoke,negative,volume]"""  # noqa
