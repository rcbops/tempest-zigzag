.PHONY: clean clean-test clean-pyc clean-build clean-venv check-venv check-unit install-venv develop-venv help
.DEFAULT_GOAL := help
...
lint: ## check style with flake8
	flake8 tempest_zigzag setup.py tests
...
release-major: develop lint test bump-major build publish ## package and upload a major release
	echo 'Successfully released!'
	echo 'Please push the newly created tag and commit to GitHub.'

release-minor: develop lint test bump-minor build publish ## package and upload a minor release
	echo 'Successfully released!'
	echo 'Please push the newly created tag and commit to GitHub.'

release-patch: develop lint test bump-patch build publish ## package and upload a patch release
	echo 'Successfully released!'
	echo 'Please push the newly created tag and commit to GitHub.'
